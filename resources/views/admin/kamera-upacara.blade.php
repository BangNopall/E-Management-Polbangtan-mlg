...
@section('container')
        ...
        <div class="mx-auto">
            ...
            <div class="bg-utama rounded-lg text-white div-shadow-kodeqr w-[95%] md:w-[450px] mx-auto p-3 md:p-5">
                ...
                <div class="text-center mb-3 mt-2 space-y-1">
                    <div class="text-lg font-semibold">Kamera Upacara</div>
    ...
    <form action="{{ route('admin.kameraKegiatanUpacaraApi') }}" method="post" id="form">
        @csrf
    ...
    <script type="text/javascript" src="{{ asset('js/scancamera-kegiatan.js') }}"></script>
@endsection
