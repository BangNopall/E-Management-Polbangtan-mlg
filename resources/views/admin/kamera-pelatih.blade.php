...
@section('container')
    <div class="px-3 py-6 md:p-6 mb-5">
        <div class="mx-auto">
            ...
            @endif
            <div class="bg-utama rounded-lg text-white div-shadow-kodeqr w-[90%] md:w-[450px] mx-auto p-3 md:p-5">
                <div class="flex justify-center items-center mb-4 w-auto mx-auto">
                    <div id="reader" style="width: 600px"></div>
                </div>
                <div class="flex gap-1 w-full">
                    <select id="cameraSelect" class="rounded bg-teal-800 border-teal-900 text-gray-100 w-full focus:ring-0 focus:border-0 block flex-1 text-sm p-2" disabled>
                ...
                <div class="text-center mb-3 mt-2 space-y-1">
                    <div class="text-lg font-semibold">Kamera Pelanggaran</div>
    ...
    <script type="text/javascript" src="{{ asset('js/scancamera-pelatih.js') }}"></script>
@endsection