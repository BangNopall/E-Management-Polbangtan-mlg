...
<body>
    <div class="container">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td width="150">NIM</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->nim }}</td>
                            </tr>
                            <tr>
                                <td width="150">Nama</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->name }}</td>
                            </tr>
                            <tr>
                                <td width="150">Program Studi</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->prodi->prodi }}</td>
                            </tr>
                            <tr>
                                <td width="150">Blok Ruangan</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->blok->name }}</td>
                            </tr>
                            <tr>
                                <td width="150">Nomor Ruangan</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->no_kamar }}</td>
                            </tr>
                            <tr>
                                <td width="150">Kelas</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->kelas->nama_kelas }}</td>
                            </tr>
                            <tr>
                                <td width="150">Asal Daerah</td>
                                <td>:</td>
                                <td>{{ $getPresensiApel[0]->user->asal_daerah }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <div class="kotak1">
            ...
            <div class="garis"></div>
            <div class="title-kategori">Apel</div>
            ...
            <div class="kotak-tabel">
                <table class="tabel-pelanggaran">
                    ...
                    <tbody>
                        @foreach ($getPresensiApel as $presensi)
                ...
                <table class="tabel-pelanggaran">
                    ...
                    <tbody>
                        <tr class="tr-pelanggarann">
                            <td class="td-bawah">Apel</td>
                            <td class="td-center">{{ $getPresensiApel[0]->total_hadir }}</td>
                            <td class="td-center">{{ $getPresensiApel[0]->total_alpha }}</td>
                            <td class="td-center">{{ $getPresensiApel[0]->total_izin }}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
