<!-- Main modal -->
<div id="upgradeModal" tabindex="-1" aria-hidden="true" role="dialog"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto" role="document">
        ...
        <div class="relative p-4 bg-white rounded-lg shadow sm:p-5">
            ...
            <p class="text-gray-800 font-semibold text-lg">Anda yakin?</p>
            <div class="text-left text-sm text-red-400 my-1 mb-4">
                <p class="mb-1">Dengan melakukan ini, Anda akan menghapus data berikut:</p>
                <i class="ri-error-warning-line mr-1"></i> Data pelanggaran<br>
                <i class="ri-error-warning-line mr-1"></i> Data absen<br>
            </div>
            <div class="flex justify-center items-center space-x-4">
                <button data-modal-toggle="upgradeModal" type="button"
