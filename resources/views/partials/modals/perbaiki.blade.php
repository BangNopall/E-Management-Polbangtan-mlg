<!-- Main modal -->
<div id="perbaikiModal{{ $dataRejecteds->id }}" tabindex="-1" aria-hidden="true" role="dialog"
    ...
    <div class="relative p-4 w-full max-w-md h-full md:h-auto" role="document">
        ...
        <div class="relative p-4 text-center bg-white rounded-lg shadow sm:p-5">
            <button type="button"
                ...
                data-modal-toggle="perbaikiModal{{ $dataRejecteds->id }}">
            ...
            <p class="mb-2 text-gray-500">Perbaiki laporan pelanggaran dengan benar!</p>
            <div class="text-sm text-gray-700 underline">Keterangan penolakan :</div>
            <div class="p-2 rounded border-2 mt-1 mb-4">
                {{ $dataRejecteds->rejected_message }}
            </div>
            <div class="flex justify-center items-center space-x-4">
                <button data-modal-toggle="perbaikiModal{{ $dataRejecteds->id }}" type="button"
